(function() {
  ...
  function _addEvents() {
    ...
    _beatSlider.addEventListener("input", function() {
      updateBPM();
      changeColors();
    });
  ...
  function beat() {
    gainNode.gain.value = 0.4; // sets audio to 40% volume
  ...
  function buildGradient() {
    ...
    gradient.addColorStop(1.0, "rgba(242, 67, 9, 1.000)");
    gradient.addColorStop(1.0, "rgba(255, 255, 255, 1.000)");
  ...
  function changeColors() {
    ...
    if (typeof InstallTrigger !== "undefined") {
      ...
      styleSheet.insertRule(
        "input[type=range]::-moz-range-thumb { background: " + bkgColor + " }",
